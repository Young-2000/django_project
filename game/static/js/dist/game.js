...
class ChatField {
    constructor(playground) {
        ...
        this.$history = $(`<div class="ac-game-chat-field-history">haha</div>`);
...
class Player extends AcGameObject {
    ...
    update_move() { // 更新玩家移动
        if (this.character === "robot" && this.spent_time > 4 && Math.random() < 1 / 300) {
...
class MultiPlayerSocket {
    constructor(playground) {
        ...
        this.ws = new WebSocket("wss://app583.acapp.acwing.com.cn/wss/multiplayer/");
        this.start();
    }
...
<div class="ac-game-settings">
    <div class="ac-game-settings-login">
        ...
        <div class="ac-game-settings-acwing">
            <img src="https://app583.acapp.acwing.com.cn/static/image/settings/acwing_log.png">
            <br>
            <div>
                AcWing一键登录
            </div>
...
`);
        ...
        this.$login_error_message = this.$login.find(".ac-game-settings-error-message input");
    ...
    acwing_login() {
        $.ajax({
            url: "https://app583.acapp.acwing.com.cn/settings/acwing/web/apply_code/",
            type: "GET",
    ...
    login_on_remote() { // 在远程服务器上登录
        ...
        $.ajax({
            url: "https://app583.acapp.acwing.com.cn/settings/login/",
            type: "GET",
            data: {
                username: username,
                password: password,
    ...
    register_on_remote() { // 在远程服务器上注册
        ...
        $.ajax({
            url: "https://app583.acapp.acwing.com.cn/settings/register/",
            type: "GET",
            data: {
                username: username,
                password: password,
    ...
    logout_on_remote() { // 在远程服务器上登出:
        if (this.platform === "ACAPP") {
            ...
            $.ajax({
                url: "https://app583.acapp.acwing.com.cn/settings/logout/",
                type: "GET",
                success: function(resp) {
                    if (resp.result === "success") {
                        location.reload();
    ...
    getinfo_acapp() {
        ...
        $.ajax({
            url: "https://app583.acapp.acwing.com.cn/settings/acwing/acapp/apply_code/",
            type: "GET",
            success: function(resp) {
                if (resp.result === "success") {
    ...
    getinfo_web() {
        ...
        $.ajax({
            url: "https://app583.acapp.acwing.com.cn/settings/getinfo/",
            type: "GET",
            data: {
