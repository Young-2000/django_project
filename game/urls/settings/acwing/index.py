...
urlpatterns = [
    path("web/apply_code/", web_apply_code, name="settings_acwing_apply_code"),
    path("web/receive_code/", web_receive_code, name="settigns_acwing_receive_code"),
    path("acapp/apply_code/", acapp_apply_code, name="settings_acwing_apply_code"),
    path("acapp/receive_code/", acapp_receive_code, name="settigns_acwing_receive_code"),
    ]
